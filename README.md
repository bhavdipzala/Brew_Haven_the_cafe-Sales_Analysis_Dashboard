...
The main **objective** of this project is to analyse retail sales data to derive various **KPI measures and actionable insights** that will enhance the performance of the coffee shop.
